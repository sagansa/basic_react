<x-admin-layout>
    ...
    <x-tables.card>
        <x-table>
            <x-slot name="head">
                <x-tables.th-left
                    >@lang('crud.permissions.inputs.name')</x-tables.th-left
                >
                <th></th>
            </x-slot>
            <x-slot name="body">
                ...
                <tr class="hover:bg-gray-50">
                    <x-tables.td-left-hide
                        >{{ $permission->name ?? '-' }}</x-tables.td-left-hide
                    >
    ...
    <div class="mt-10 px-4">{!! $permissions->render() !!}</div>
</x-admin-layout>
